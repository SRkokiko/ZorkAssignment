...
bool HelpAction::Execute(World& world, const std::string& args)
{
    ...
    std::cout << "  " << Bold("take/pick") << " <target> " << Bold("from") << " <container> -Take an item out of a container\n";
    std::cout << "  " << Bold("drop") << " <target>  - Drop an item from your inventory\n";
    std::cout << "  " << Bold("put") << " <target> " << Bold("in / into") << " <target> -Place an item in your inventory into a container\n";
